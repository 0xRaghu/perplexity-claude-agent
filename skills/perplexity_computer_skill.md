<!--
  Perplexity Computer Custom Skill Template
  From: perplexity-claude-agent
  Repo: https://github.com/0xRaghu/perplexity-claude-agent

  Copy this entire file and paste it as a custom skill in Perplexity Computer.
  For a version customized with your registered projects, run:
